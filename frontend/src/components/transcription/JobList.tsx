import { Trash2, Play, Eye, Loader2, AlertCircle, CheckCircle2 } from "lucide-react";
      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-border bg-muted/50">
            ...
            <th className="text-left py-3 px-4 font-medium hidden md:table-cell">Durée</th>
              ...
              <tr key={job.id} className="border-b border-border last:border-0 hover:bg-muted/30">
                ...
                <td className="py-3 px-4">
                  <div className="flex items-center justify-end gap-1">
                    ...
                    {(job.status === "completed" || ["converting", "diarizing", "transcribing", "aligning"].includes(job.status)) && (
