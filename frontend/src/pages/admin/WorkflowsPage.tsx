...
import { Settings2, Plus, Trash2, ChevronDown, ChevronUp, Sparkles, Loader2, FileText, Users, Mail, ClipboardList, Upload, CheckSquare, Pencil } from "lucide-react";
...
function SectorDocTemplateManager({ sector }: { sector: string }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {templates.length === 0 ? (
        <p className="text-sm text-muted-foreground text-center py-6">
          Aucun template de document IA pour ce secteur. Les seeds par defaut seront utilisees.
        </p>
      ) : (
        <div className="space-y-2">
          {templates.map((tpl) => (
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <Textarea
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setForm({ ...form, system_prompt: e.target.value })}
            ...
            <div className="space-y-1">
              ...
              <Textarea
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setForm({ ...form, user_prompt_template: e.target.value })}
            ...
            <div className="space-y-1">
              ...
              <Textarea
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setForm({ ...form, map_system_prompt: e.target.value })}
...
export function WorkflowsPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold">Templates par secteur</h1>
        <p className="text-sm text-muted-foreground">
          Gerez les templates de procedure et de documents IA par secteur d'activite
        </p>
      </div>
          ...
          {selectedSector ? (
            <div className="bg-background rounded-xl border border-border p-6">
              ...
              <div className="mt-6 pt-6 border-t border-border">
                <SectorDocTemplateManager sector={selectedSector} />
              </div>
            </div>
          ) : (
