...
export function TenantsPage() {
  ...
  const orgTenants = tenants.filter((t) => t.tenant_type === "organization");
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-2">
            ...
            <>
              ...
              {groups.map((g) => (
                <div key={g.id}>
                  ...
                  {orgTenants.filter((o) => o.parent_id === g.id).map((o) => (
          ...
          {orgTenants.filter((o) => !o.parent_id).map((o) => (
          ...
          {selected ? (
            <div className="bg-background rounded-xl border border-border p-6">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                {selected.slug} &middot; {selected.tenant_type === "group" ? "Groupe" : "Tenant"}
                {selected.sector && (
              ...
              <>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select value={form.sector ?? ""} onValueChange={(v) => handleSectorChange(v === "__none__" ? null : v)}>
                      <SelectTrigger className="w-full">
                        <SelectValue placeholder="— Générique (sans provisionnement) —" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="__none__">— Générique (sans provisionnement) —</SelectItem>
                        {sectors.map((s) => (
