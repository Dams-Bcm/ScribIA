...
class Procedure(UUIDMixin, TimestampMixin, Base):
    ...
    # Document IA à générer (référence souple — pas de FK car le template
    # peut être global et résider dans une base différente)
    document_template_id = Column(String(36), nullable=True)
